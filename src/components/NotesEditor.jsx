  ...
  function NotesEditor() {
    ...
    useEffect(() => {
      ...
      // When selecting a note on compact mode,
    ...
    const handleCreate = () => {
      ...
      // Keep sidebar open when creating a note
      // from desktop.
      if (window.innerWidth > 760) {
        setSidebarOpen(true);
      }
            ...
            <div className="relative flex min-h-0 flex-1 flex-col">
              ...
              <div className="absolute left-3 top-3 z-10">
                <button
                  ...
                  className="rounded-lg border border-slate-800 bg-slate-900/90 px-3 py-2 text-xs font-medium text-slate-400 shadow-lg backdrop-blur transition hover:border-slate-700 hover:bg-slate-800 hover:text-white"
                >
